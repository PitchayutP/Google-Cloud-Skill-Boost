...
gcloud projects add-iam-policy-binding $DEVSHELL_PROJECT_ID --member=serviceAccount:$SANAME@$DEVSHELL_PROJECT_ID.iam.gserviceaccount.com --role=ROLE_NAME
...
Click on the open editor and click on the right click on the blank space and select New File
Give file name as: analyze-images-v2.py

Only change the locale in line no 80 & 89
Do not change anything in file.
...
Run below command in cloud shell
